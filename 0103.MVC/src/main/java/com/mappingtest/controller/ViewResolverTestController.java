...
import com.mappingtest.model.Custommer;
...
//		return "viewEx/v01";
	...
	public List<Custommer> view03(Model model) {

		List<Custommer> list = new ArrayList<Custommer>();
		list.add((Custommer)this.context.getBean("custommer"));
		list.add((Custommer)this.context.getBean("custommer"));
		list.add((Custommer)this.context.getBean("custommer"));
		list.add((Custommer)this.context.getBean("custommer"));
		list.add((Custommer)this.context.getBean("custommer"));
