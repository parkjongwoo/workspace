	...
	<div class="container">
		...
		<input type="hidden" name="num" value="${guestbookItem.num}">
			<div class="form-group">
				...
				<input type="text" class="form-control" id="name" name="name" value="${guestbookItem.name}">
			</div>
			<div class="form-group">
				<label for="exampleFormControlInput1">제목입력</label> 
				<input type="text" class="form-control" id="subject" name="subject"  value="${guestbookItem.subject}">
			</div>
			<div class="form-group">
